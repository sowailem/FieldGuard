...
class CreateFieldGuardRuleRequest extends FormRequest
{
    /**
    ...
    {
        return Gate::any(['manage-field-guard', 'create-field-guard']);
    }
    ...
    {
        return [
            'model_class' => ['required', 'string', function ($attribute, $value, $fail) {
